...
class advertise_controller extends common{
	...
	function class_action(){
        ...
        $ad_class_list1=$M->DB_select_all('ad_class','`pid`=0');
		if($_GET['ad_id']){
			$ad_class = $this->obj->DB_select_once("ad_class","`id`='".$_GET['ad_id']."'");
		}
		$this->yunset(array('ad_class_list1'=>$ad_class_list1,'ad_class'=>$ad_class,'ad_class_list'=>$ad_class_list));
		$this->yuntpl('admin/admin_ad_class');
	}
