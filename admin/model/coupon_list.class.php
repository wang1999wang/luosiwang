...
class coupon_list_controller extends common
{
	...
	function set_search(){
		...
		$search_list[]=array("param"=>"status","name"=>'消费状态',"value"=>array("1"=>"未消费","2"=>"已消费"));
		$search_list[]=array("param"=>"receive","name"=>'获赠时间',"value"=>array("1"=>"今天","3"=>"最近三天","7"=>"最近七天","15"=>"最近半月","30"=>"最近一个月"));
