...
>
    ...
    <style>
        <!--
        .mainright a, .maincontent a:visited {
            color: #F00;
        ...
        <div class="admin_index_center">
            <div class="admin_message_left">
                <div class="admin_message_left_cont">
                    ...
                    <div class="admin_message_login">
                        您的登陆帐户，<strong><?php echo $_smarty_tpl->tpl_vars['nav_user']->value['username'];?>
</strong>
                    ...
                    <div class="admin_message_jy">
                        <?php if ($_smarty_tpl->tpl_vars['dirname']->value||$_smarty_tpl->tpl_vars['mruser']->value==1) {?><div>
                            ...
                            <p>
                                强烈建议将 <?php echo $_smarty_tpl->tpl_vars['dirname']->value;?>
 文件夹名改为其它名称！
                                <?php }?>
                                <?php if ($_smarty_tpl->tpl_vars['mruser']->value==1) {?>
                                没有更改默认的管理员名称和密码!<a href="index.php?m=admin_user&c=pass">【马上修改】</a>
                            </p><?php }?>
                        </div>
                        <?php }?>
                    </div>
