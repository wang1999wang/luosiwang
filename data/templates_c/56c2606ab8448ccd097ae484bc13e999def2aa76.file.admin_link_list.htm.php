...
<div id="infobox2"  style="display:none; width: 350px; "> 
      ...
      <div class="admin_Operating_sh" style="margin:15px 10px 10px 10px;">
		...
		<div class="admin_Operating_sub" style="margin:15px 0 0 0;"> <input type="submit"  value='确认' class="submit_btn ">
         <input type="button"  onClick="layer.closeAll();" class="cancel_btn" style="margin:5px 0 0 8px;" value='取消'></div>
		</div>
