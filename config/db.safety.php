...
function gpc2sql($str,$str2) {
	...
	$arr=array("sleep"=>"£Óleep"," and "=>" an d "," or "=>" £Ïr ","%20"=>" ","select"=>"£Óelect","update"=>"£Õpdate","count"=>"£Ãount","chr"=>"£Ãhr","truncate"=>"£Ôruncate","delete"=>"£Äelete","insert"=>"£Énsert","<"=>"&lt;",">"=>"&gt;","\""=>"&quot;","'"=>"&acute;","--"=>"- -","\("=>"£¨","\)"=>"£©","00000000"=>"OOOOOOOO");
